...
const DarshanSchema = require('../db/Organizer/DarshanSchema');
...
router.post('/userbooking', async (req, res) => {
    const { organizerName, description, prices, name,email,phno,templeName, darshanName, location, templeImage, organizerId,open,close, totalamount, BookingDate,  userId, userName: String, quantity  } = req.body;
    try {
        const order = new bookings({ organizerName, description, prices, name,email,phno, templeName, darshanName, location, templeImage, organizerId,open,close, totalamount, BookingDate,  userId, userName: String, quantity});
        await order.save();
